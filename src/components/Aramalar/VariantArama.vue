                        ...
                        <el-row>
                            ...
                            <el-row>
                                ...
                                <el-col :xs="4" :lg="4" :span="2">
                                    <el-form-item>
                                        <el-input prefix-icon="el-icon-search" placeholder="Variant Kodu"
                                                  v-model="paginateFilter.VariantKod" @input="querySearch"></el-input>
                                    </el-form-item>
                                </el-col>

                                <el-col :xs="6" :lg="6" :span="2">
                                    <el-form-item>
                                        <el-input prefix-icon="el-icon-search" placeholder="Variant Tanım"
                                                  v-model="paginateFilter.VariantTanim" @input="querySearch"></el-input>
                                    </el-form-item>
                                </el-col>
...
<script>
    import StokKontrol_VariantlarService from "@/services/StokKontrol/Variantlar";
