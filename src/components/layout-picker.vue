...
export default {
	...
	computed: {
		navPos: {
			get() {
				return this.$store.getters['app/navPos']
			},
			set(val) {
				this.$store.commit('app/setLayout', {navPos:val})
			}
		},
		toolbar: {
			get() {
				return this.$store.getters['app/toolbar']
			},
			set(val) {
				this.$store.commit('app/setLayout', {toolbar:val})
			}
		},
		footer: {
			get() {
				return this.$store.getters['app/footer']
			},
			set(val) {
				this.$store.commit('app/setLayout', {footer:val})
			}
		},
		boxed: {
			get() {
				return this.$store.getters['app/boxed']
			},
			set(val) {
				this.$store.commit('app/setLayout', {boxed:val})
			}
		},
		roundedCorners: {
			get() {
				return this.$store.getters['app/roundedCorners']
			},
			set(val) {
				this.$store.commit('app/setLayout', {roundedCorners:val})
			}
		},
		viewAnimation: {
			get() {
				return this.$store.getters['app/viewAnimation']
			},
			set(val) {
				this.$store.commit('app/setLayout', {viewAnimation:val})
			}
		}
	},	
	methods: {
